      ...
      testimonials: [
        {
          ...
          avatarSrcset: './assets/img/avatars/te1@2x.jpg 2x',
          name: 'Coriss Ambady',
        ...
        },
        {
          ...
          avatarSrcset: './assets/img/avatars/te2@2x.jpg 2x',
          name: 'Cory Zamora',
  ...
  template: `
    <section class="wrapper bg-dark">
      <div class="container py-14 py-md-16">
        ...
        <h2 class="display-4 mb-3 text-center text-primary">Client Reviews</h2>
        <div class="position-relative">
          ...
          <div class="shape bg-dot red rellax w-16 h-16" data-rellax-speed="1" style="top: -1rem; left: -1.7rem;"></div>
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide" v-for="(testimonial, index) in testimonials" :key="index">
                  <div class="item-inner">
                    <div class="card bg-card-custom text-primary">
                      <div class="card-body">
                        <blockquote class="icon mb-0">
                          <p>{{ testimonial.quote }}</p>
                          <div class="blockquote-details">
                            <img class="rounded-circle w-12" :src="testimonial.avatar" :srcset="testimonial.avatarSrcset" alt="" />
                            <div class="info">
                              <h5 class="mb-1 text-secondary">{{ testimonial.name }}</h5>
